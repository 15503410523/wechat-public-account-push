  ...
  USERS: [
    {
      ...
      id: 'o4eVj6O2AsO3XEiFB4rM5Ap2gk3w',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: '0lV0tbhww7UT1uvAvIq9Mu3eeiSQDVr3jqzBOOVUytk',
      // 所在省份
      province: '上海',
      // 所在城市
      city: '上海',
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '老婆', year: '1998', date: '09-09',
        },
//         {
...
//         },
        {
          type: '节日', name: '在一起的日子', year: '2022', date: '11-01',
        }
      ],
